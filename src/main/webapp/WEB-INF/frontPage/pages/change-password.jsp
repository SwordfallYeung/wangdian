...
<div data-role="page">
    ...
    <div data-role="header" class="fixed-header">
        <a href="${pageContext.request.contextPath}/userCenter" class="ui-btn" data-rel="back">返回</a>
        <h1>修改密码</h1>
    </div>
    ...
    <div data-role="main" class="ui-content">
        <form method="post" action="${pageContext.request.contextPath}/changePassword" id="changePwdForm">
            <div class="ui-field-contain">
