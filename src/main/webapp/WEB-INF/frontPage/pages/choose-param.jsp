...
<div data-role="page">
    ...
    <div data-role="main" class="ui-content">
        ...
        <div class="chosen-info">
            <div class="name">商品名称：<span>${shop.name}</span></div>
            <div class="price">商品单价：<span>￥<c:if test="${type.equals('shop')}">${shop.secondCost}</c:if> <c:if test="${type.equals('shunShop')}">${shop.thirdCost}</c:if> </span></div>
            <div class="parameter">
                <span>已选参数：</span>
