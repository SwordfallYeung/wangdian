...
<div data-role="page">
    ...
    <div data-role="header" class="fixed-header">
        ...
        <c:if test="${direction.equals('addToShopCart')}">
            <a href="${pageContext.request.contextPath}/myShopCart" class="ui-btn" data-ajax="false">返回</a>
        </c:if>
        <h1>提交订单</h1>
    </div>
    ...
    <div data-role="main" class="ui-content">
        ...
        <form method="post" action="${pageContext.request.contextPath}/submitOrder" data-ajax="false">
            ...
            <fieldset class="ui-field-contain choose-address">
                ...
                <c:if test="${userAddressList.size()<=0}">
                    <div class="no-address">您当前还没有收货地址，赶紧去<a href="${pageContext.request.contextPath}/addAddress?userId=${user.id}" data-ajax="false">添加</a>吧！</div>
                </c:if>
            ...
            <div class="remark">
                <label>买家留言：</label><textarea name="liuYan"></textarea>
            </div>
