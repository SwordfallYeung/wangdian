                 ...
                 <tbody>
                       ...
                       <tr >
                           <td colspan="2" style="width: 50%;">
                               ...
                               <input type="text" data-rule="required" name="shopType" value="${shop.shopType}" size="20">
                           </td>
                           <td colspan="2">
                               <label class="control-label x100">商品型号：</label>
                               <input type="text" data-rule="required" name="shopModel" value="${shop.shopModel}" size="20">
                           </td>
                       </tr>
                       ...
                       <tr>
                           <td colspan="2" style="width: 50%;">
                               ...
                               <input type="text" data-rule="required" name="firstCost" value="${shop.firstCost}" size="20">元
                           </td>
                           <td colspan="2">
             ...
             <table id="tabledit1" class="table table-bordered table-hover table-striped table-top" data-toggle="tabledit" data-initnum="0" data-single-noindex="true" width="100%">
                 ...
                 <tr >
                     ...
                     <th style="width: 12%" align="center" title="" data-addtool="true">
                         ...
                         <a href="${pageContext.request.contextPath}/admin/shop/ajaxDone" class="btn btn-red row-del" data-confirm-msg="确定要删除该行信息吗？">删</a>
                     </th>
                 </tr>
                 </thead>
                 <tbody>
