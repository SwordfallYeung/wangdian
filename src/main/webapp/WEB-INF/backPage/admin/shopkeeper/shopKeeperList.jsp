...
<div class="bjui-pageContent">
    ...
    <table class="table table-bordered table-hover table-striped table-top" data-selected-multi="true">
        ...
        <tr>
            ...
            <th data-order-field="webUrl">店主网店</th>
        ...
        <c:forEach var="list" items="${shopKeeperList.content}" varStatus="i">
            <tr>
                ...
                <td>${list.nickname}</td>
                <td>${list.email}</td>
                <td>${list.webUrl}.${yuMing.yuming}</td>
                ...
                <td>
                    <a href="${pageContext.request.contextPath}/admin/shopKeeper/add?id=${list.id}" class="btn btn-default" data-toggle="dialog" data-width="900" data-height="300" data-id="dialog-mask" data-mask="true">编辑</a>
